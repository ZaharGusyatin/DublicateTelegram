package com.example.duplicatetelegram.database
...
import com.example.duplicatetelegram.utilits.AppValueEventListener
...
fun changeUserName3(newUserName: String) {
    REF_DATA_BASE_ROOT.child(
        NODE_USERS
    ).child(CURRENT_UID).child(
        CHILD_USERNAME
